						...
						<!-- Content -->
                              ...
                              <div class="row row-cols-1 row-cols-md-3 g-4" class="features">
                                  ...
                                  <div class=" ">
                                    ...
                                    <article class="">
                                        <a href="#" class="image"><img src="{{'contact/'. $contact->image }}"  height="300px" width="414px"/></a>
                                        <h3 class="major">{{ $contact->name }}</h3>
                                        <p>{{ $contact->email}}</p>
                                        <p>{{ $contact->message}}</p>
                                        <a href="{{route('contact.destroy', $contact->id)}}" class="special" style="display: inline">Delete</a>
