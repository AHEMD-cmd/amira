					...
					<section id="wrapper" class="container">
                        ...
                        <form action="{{route('project.update', $project->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                              ...
                              <textarea name="desc" cols="30" rows="10" class="@error('desc') is-invalid @enderror">{{$project->title}}</textarea>
                              @error('desc')
                              <div  class="invalid-feedback">{{$message}}</div>
                              @enderror
                            </div>
                            ...
                            <img src="{{'cover/'. $project->cover }}" width="100px" height="100px" >
                            ...
                            <img src="{{'images/'. $img->image }}" width="100px" height="100px">
                            <a href="{{route('image.destroy', $img->id)}}" class="btn btn-outline-info">x</a>
